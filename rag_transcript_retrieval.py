...
def summarize_chunk(chunk_text):
    prompt = (
        f"You are a legal assistant. Please summarize the following court transcript passage:\n\n"
        f"{chunk_text}\n\nSummary:")
...
def final_grounded_summary(intermediate_summary, support_docs, case_id):
    ...
    final_prompt = (
        f"You are a legal expert summarizing oral arguments.\n\n"
        f"Below is a summary of the full hearing:\n{intermediate_summary}\n\n"
        f"Ground your final summary using the retrieved legal opinion excerpts below."
        f" Use numbered citations [1], [2], etc., to indicate support.\n\n"
        f"Retrieved Legal Opinion Excerpts:\n{retrieved_opinion_chunks_text}\n\n"
        f"Final Summary:")
